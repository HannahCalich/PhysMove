...
```{r plot all norm disp, echo=TRUE, error=FALSE, message=FALSE, out.width="50%"}
...
```{r plot all disp (not norm), echo=TRUE, error=FALSE, message=FALSE, out.width="50%"}
...
```{r plot 24 hr disp, echo=TRUE, error=FALSE, message=FALSE, out.width="50%"}
...
```{r plot full dist, echo=TRUE, error=FALSE, message=FALSE, out.width="50%"}
...
```{r plot trunc dist, echo=TRUE, message=FALSE, out.width="50%"}
...
```{r calc turn angles, echo=TRUE, out.width="40%"}
