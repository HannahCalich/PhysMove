...
`r if (ms) paste0("![](", "images/PhysMoveHex.png", "){width='",50, "'}")`
<img src="../vignettes/PhysMoveHex.png" align="right" width="130" />

```{r logo, echo=FALSE, fig.align="right", fig.width=2.5, fig.height=2.5}
# if (ms==TRUE){
#   knitr::include_graphics(normalizePath("./vignettes/word_formatted/images/PhysMoveHex.png"), rel_path = FALSE)
# }
```
...
```{r tracks_head, echo=FALSE, fig.width=6.5, fig.height=1.25}
# if (ms==TRUE){
#   knitr::include_graphics(normalizePath("./vignettes/word_formatted/tables/tracks_head.png"), rel_path = FALSE)
# }
```
`r if (ms) paste0("![](", "tables/tracks_head.png", ")")`
...
```{r tracks_str, echo=FALSE, fig.width=6.5, fig.height=0.7}
# if (ms==TRUE){
#   knitr::include_graphics(normalizePath("./vignettes/word_formatted/tables/tracks_str.png"), rel_path = FALSE)
# }
```
`r if (ms) paste0("![](", "tables/tracks_str.png", ")")`
...
```{r plot_tracks, eval=FALSE, message=FALSE}
plotTracks(tracks)
```

```{r tracks_image, echo=FALSE, fig.width=5, fig.height=3.5}
# if (ms==TRUE){
#   knitr::include_graphics(normalizePath("./vignettes/word_formatted/images/plot_tracks-1.png"), rel_path = FALSE)
# }
```
`r if (ms) paste0("![](", "images/plot_tracks-1.png", ")")`
