...
```{r summary_rms_load_fig, echo=FALSE, fig.align='left'}
...
```{r rms_lm_load_fig, echo=FALSE, fig.align='left'}
...
```{r hurst_load_fig, echo=FALSE, fig.align='left'}
...
```{r summary_disp_load_fig, echo=FALSE, fig.align='left'}
knitr::include_graphics("../vignettes/word_formatted/tables/summary_disp.png")
```
...
# First chunk to fetch the image size and calculate its aspect ratio
img <- magick::image_read("../vignettes/word_formatted/images/plot_all_disp-1.png") # read the image using the magic library
img.asp <- magick::image_info(img)$height / magick::image_info(img)$width # calculate the figures aspect ratio
```

```{r all_disp_load_fig, echo=FALSE, fig.asp=img.asp, out.width="60%"}
knitr::include_graphics("../vignettes/word_formatted/images/plot_all_disp-1.png")
```
...
```{r summary_disp24_load_fig, echo=FALSE, echo=FALSE, fig.align='left'}
...
```{r dist_full_load_fig, echo=FALSE, echo=FALSE, fig.align='left'}
...
```{r dist_full_comp_load, echo=FALSE, echo=FALSE, fig.align='left'}
...
```{r find best-fit d_min for each dist, eval=FALSE}
...
```{r dist_trunc_load, echo=FALSE, echo=FALSE, fig.align='left'}
...
# First chunk to fetch the image size and calculate its aspect ratio
img <- magick::image_read("../vignettes/word_formatted/images/plot_trunc_dis-1.png") # read the image using the magic library
img.asp <- magick::image_info(img)$height / magick::image_info(img)$width # calculate the figures aspect ratio
```
...
```{r pl_trunc_dist_load, echo=FALSE, fig.align='left'}
...
```{r exp_trunc_dist_load, echo=FALSE, fig.align='left'}
...
```{r lnorm_trunc_dist_load, echo=FALSE, fig.align='left'}
...
```{r summarise_random_load, echo=FALSE, fig.align='left'}
...
```{r summarise_random_lm_load, echo=FALSE, fig.align='left'}
...
```{r summary_angles_load, echo=FALSE, fig.align='left'}
...
knitr::include_graphics("../vignettes/word_formatted/images/plot_angles_circle_plot1-1.png")
```
