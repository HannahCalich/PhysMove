...
`r if (ms) paste0("![](", "images/PhysMoveHex.png", "){width='",130, "'}")`
...
# Create a ccdf plot of displacements with fit lines illustrating 
# distributions fit to the best-fit xmin for each distribution
...
# Fit all distributions using the xmin value for the 
