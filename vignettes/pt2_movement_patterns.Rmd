...
```
`r if (ms) paste0("![](", "images/calcualte_rms-1.png", ")")`
...
```
`r if (ms) paste0("![](", "tables/summary_rms.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "tables/rms_lm.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "tables/hurst.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "tables/summary_disp_all_24.png", "){width=800}")`
...
# Create a probability density function (pdf) plot of normalized 
# displacements
plot.data <- plotDispPDF(disp.all)
```
`r if (ms) paste0("![](", "images/plot_all_norm_disp-1.png", ")")`
...
```
`r if (ms) paste0("![](", "images/plot_all_disp_not_norm-1.png", ")")`
...
`r if (ms) paste0("![](", "images/FitDistFlowChart_updated.png", ")")`
...
summary(unlist(disp))
```
`r if (ms) paste0("![](", "tables/summary_disp24.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "images/plot_24hr_disp-1.png", ")")`
...
```
`r if (ms) paste0("![](", "tables/dist_full.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "images/plot_full_dist-1.png", ")")`
...
compResults
```
`r if (ms) paste0("![](", "tables/dist_full_comp.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "tables/dist_trunc.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "images/plot_trunc_dist-1.png", ")")`
...
compResultsPl
```
`r if (ms) paste0("![](", "tables/dist_pl_comp.png", "){width=800}")`
...
compResultsExp
```
`r if (ms) paste0("![](", "tables/dist_exp_comp.png", "){width=800}")`
...
compResultsLnorm
```
`r if (ms) paste0("![](", "tables/dist_lnorm_comp.png", "){width=800}")`
...
# randomise() involves random number selection, so setting a seed enables the 
...
```
`r if (ms) paste0("![](", "images/randomise_tracks-1.png", ")")`
...
```
`r if (ms) paste0("![](", "tables/summary_randomise.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "tables/randomise_lm.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "tables/randomise_exp.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "images/plot_random_tracks-1.png", ")")`
...
`r if (ms) paste0("![](", "images/turn_angles.png", ")")`
<img src="../vignettes/word_formatted/images/turn_angles.png" width=60%" />
...
```
`r if (ms) paste0("![](", "tables/summary_angles.png", "){width=800}")`
...
```
`r if (ms) paste0("![](", "images/plot_angles_circle_plot.png", ")")`
<img src="../vignettes/word_formatted/images/plot_angles_circle_plot.png" width=60%" />
