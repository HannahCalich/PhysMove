...
```{r calculate_rms, eval=FALSE}
# Calculate RMS values with default parameters
rms.result <- rms(tracks)
```
`r if (ms) paste0("![](", "images/calculate_rms-1.png", ")")`
<img src="../vignettes/word_formatted/images/calculate_rms-1.png" width="60%" />
...
```{r calculate scaling exponent, eval=FALSE}
...
```{r scaling exponent, eval=FALSE}
# Determine the scaling exponent 
RMSlinearModel$estimate[2]
```
`r if (ms) paste0("![](", "tables/scaling_exp.png", "){width=800}")`
<img src="../vignettes/word_formatted/tables/scaling_exp.png" width="100%" />
