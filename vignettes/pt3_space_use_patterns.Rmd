...
The `occupancy()` function helps describe species’ space-use patterns by calculating the number of location estimates within each grid cell and dividing this by the grid cell’s area, calculated using spherical coordinates (Figure V14). 
