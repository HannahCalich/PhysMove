...
vignette: >
  ...
  %\VignetteIndexEntry{PhysMove: Space-Use Pattern}
...
summary(Occ) # Select data frame of occupancy results
```
...
```{r infomap map, echo=TRUE, message=FALSE, fig.width = 7, fig.height = 5, out.width="60%"}
