...
The `Occupancy()` function requires a dataframe with telemetry data (as described above) and includes three optional parameters:
...
`Occupancy()` outputs a dataframe of all results, including:
...
```{r calc occ, echo=TRUE, message=FALSE, fig.width = 7, fig.height = 5, out.width="60%"}
...
```{r pdf occ, echo=TRUE, fig.width = 7, fig.height = 5, out.width="60%"}
...
The `InfomapCommunities()` function requires a dataframe with telemetry data (as described above) and includes five optional parameters:
...
```{r, echo=TRUE, message=FALSE, fig.width = 7, fig.height = 5, out.width="60%"}
...
```{r, echo=TRUE, fig.width = 7, fig.height = 5, out.width="60%"}
