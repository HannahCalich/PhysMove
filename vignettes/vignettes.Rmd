...
htmltools::img(src = knitr::image_uri("vignettes/PhysMoveHex.PNG"), 
              #alt = 'logo',  
              style = 'position:absolute; top:0; right:50; padding:10px; border:0',
...
The code used to make the `tracks` dataset is available in the PhysMove data folder on GitHub as “CreateTracks.R”.
