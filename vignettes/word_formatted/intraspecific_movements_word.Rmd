...
`GyrationRad()` requires a data frame with telemetry data (as described above) and includes two optional parameters:
...
`GyrationRad()` outputs a data frame of the results, which were used to create each map, including: 
...
`Entropy()` requires a data frame with telemetry data (as described above) and includes two optional parameters:
...
`Predictability()` requires a data frame with telemetry data (as described above) and a data frame of results output from `Entropy()`, and includes two optional parameters:
