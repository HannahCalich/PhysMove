...
1) set your working directory to the folder that contains the stand-alone Infomap file (*Infomap.exe*) using `setwd()` and 2) load the infomap ecology r package using `library(infomapecology)`
...
```
`r if (ms) paste0("![](", "tables/infomap_str.png", ")")`
<img src="../vignettes/word_formatted/tables/infomap_str.png" width="50%" />
...
```
`r if (ms) paste0("![](", "images/infomap_map-1.png", ")")`
<img src="../vignettes/word_formatted/images/infomap_map-1.png" width="60%" />
...
The `occupancy()` function helps describe species’ space-use patterns by calculating the total number of location estimates within each grid cell and dividing this sum by the grid cell’s area, calculated using spherical coordinates (Figure V14). 
...
```
`r if (ms) paste0("![](", "images/occ_map-1.png", ")")`
<img src="../vignettes/word_formatted/images/occ_map-1.png" width="60%" />
...
summary(Occ) 
```
`r if (ms) paste0("![](", "tables/summary_occ.png", ")")`
<img src="../vignettes/word_formatted/tables/summary_occ.png" width="100%" />
...
```
`r if (ms) paste0("![](", "images/occ_pdf-1.png", ")")`
<img src="../vignettes/word_formatted/images/occ_pdf-1.png" width="60%" />
